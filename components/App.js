...
import { Route, Switch } from 'react-router-dom' // Import Switch for route rendering
...
import LandingPage from './General/ReactHome'
  ...
  render () {
    return (
      <Layout style={{ minHeight: '100vh', lineHeight: '1.6rem' }}>
        ...
        <Layout>
          <Switch>
            <Route path="/" exact component={LandingPage} /> {/* LandingPage for root path */}
